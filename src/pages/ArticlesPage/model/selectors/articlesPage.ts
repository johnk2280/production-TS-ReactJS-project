...
export const getArticlesPageSortField = (state: StateSchema): ArticleSortField => state.articlesPage?.sortField ?? ArticleSortField.CREATED_AT;
...
export const getArticlesPageType = (state: StateSchema): string => state.articlesPage?.type ?? ArticleType.ALL;
